...
const Hero = () => {
    const buttonStyle = 'bg-orange-400 p-4 text-dark rounded inline-block w-[190.82px]'
    return (
        <div className="flex mt-[5rem] items-center">
            <div className="flex flex-col flex-wrap w-[792.65px]">
                <h1 className="text-[58.7149px] text-[#FFFFFF] font-[700] leading-[72px] flex-shrink-0">Multi-currency banking for <span className="text-[#FF9E0B]">African</span> businesses</h1>
