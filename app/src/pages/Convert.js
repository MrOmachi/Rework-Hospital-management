        ...
        <Col md={12} sm={12} lg={12}>
          <div className="board padding">
            <Form className="pay-form">
              ...
              <Form.Group
                className="mb-3 recipient-control"
                controlId="formGridAddress2"
              >
                <Form.Label>
                  Amount you’ll receive in your destination account
                </Form.Label>
              ...
              <fieldset>
                <Form.Group as={Row}>
                  <Col sm={12} md={6}>
                    <b className="pull-right">
                      {formatAmount(conversionFee, account.Currency)}
                    </b>
                    <Form.Check
                      style={{ marginLeft: 30 }}
                      type="radio"
                ...
                <Form.Group className="check-control" as={Row}>
                  <Col sm={12} md={6}>
                    <b className="pull-right">
                      {formatAmount(fee, account.Currency)}
                    </b>
                    <Form.Check
                      style={{ marginLeft: 30 }}
                      type="radio"
