    ...
    return (
        <div className="flex sm:mt-[5rem] flex-col sm:flex-row  items-center gap-[1.5rem]">
            <div className="flex flex-col flex-wrap sm:w-[942.65px]">
                <h1 className="sm:text-[58.7149px] text-[33px] text-[#FFFFFF] font-[700] sm:leading-[72px] flex-shrink-0 mt-[2rem] sm:mt-[0rem] mb-[1rem]">Multi-currency banking for <span className="text-[#FF9E0B]">African</span> businesses</h1>
