    ...
    return (
        <div className="flex sm:mt-[5rem] flex-col sm:flex-row justify-center items-center gap-[1.5rem]">
            <div className="flex flex-col flex-wrap sm:w-[942.65px] sm:pt-[9rem] pt-[.5rem]">
                <h1 className="lg:text-[50px] md:mt-[-5rem] md:text[23.486px] text-[20px] text-[#FFFFFF] font-[700] flex-shrink-0 mt-[6rem] sm:mt-[0rem] pb-[1rem] md:mb-[1rem]">Multi-currency banking for <span className="text-[#FF9E0B]">African</span> businesses</h1>
