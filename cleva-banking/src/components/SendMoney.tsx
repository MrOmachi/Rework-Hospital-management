...
const SendMoney = (props: ISendMoney) => {
  return (
    <div className='grid grid-cols-1 sm:grid-cols-2 sm:gap-[238.77px] justify-between items-center sm:px-[82.2px] px-[2rem] mt-[2rem]'>
     <div>
      <h1 className="sm:text-[35.2289px] text-[25px] font-[600] leading-[43px] break-normal md:break-all text-center sm:text-left">Send money <span className='text-[#FF9E0B]'>locally</span> and <span className="text-[#FF9E0B]">across borders</span></h1>
