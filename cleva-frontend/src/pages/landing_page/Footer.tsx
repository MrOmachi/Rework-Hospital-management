...
const Footer = (props: IFooter) => {
  ...
  if (state.succeeded) {
    return (
      <div className="text-[2rem] text-center my-[2rem]">
        Thanks for joining!
      </div>
    );
  }
  ...
  return (
    <div className="bg-[#FFDCA7]" ref={innerRef}>
      ...
      <h1 className="sm:text-[35.2289px] font-[600] leading-[43px] sm:mb-[56.7px] text-center">
        Cleva banking is smart banking!
      </h1>
      <div className=" bg-black rounded-lg grid grid-cols-1 lg:grid-cols-2 justify-between items-center lg:py-[94.92px] xl:pl-[3rem] xl:gap-[12rem] px-[3rem]  mt-[2rem] sm:mx-[5rem]">
        <div className="text-white ml-[-1rem] sm:ml-[1.5rem]">
          ...
          <div className="text-[#FFFFFF] leading-[24px] mt-[30.34px] sm:pr-[6rem]">
            ...
            <span>
              {" "}
              We’ll only use your information to contact you about Cleva and
              nothing else.
            </span>
          </div>
          {screenWidth > 640 ? (
            <div className="lg:mt-[292.5px] mt-[2rem]">
        ...
        <div className="px-[21.31px] sm:px-[32.31px] rounded-lg  bg-[#FF9E0B] sm:w-[437.12px] xl:w-[437.12px] my-[2rem] md:ml-[1.5rem] lg:ml-[-1.7rem] xl:ml-[0rem] sm:ml-[1.5rem]">
          <form className="pt-[24.86px] pb-[24.86px]" onSubmit={handleSubmit}>
            <div className="flex justify-between mb-4">
              <input
                className="shadow appearance-none border rounded w-full py-2 px-3 text-[#606060] leading-tight focus:outline-none focus:shadow-outline mr-[23.49px] placeholder:text-[15.6573px]"
                type="text"
              ...
              />
              <input
                className="shadow appearance-none border rounded w-full py-2 px-3 text-[#606060] leading-tight focus:outline-none focus:shadow-outline placeholder:text-[15.6573px]"
                type="text"
            ...
            <div className="mb-4">
              <input
                className="shadow appearance-none border rounded w-full py-2 px-3 text-[#606060] leading-tight focus:outline-none focus:shadow-outline"
                type="text"
            ...
            <div>
              ...
              <input
                className="shadow appearance-none border rounded mb-4 w-full mt-4 py-2 px-3 text-[#606060] leading-tight focus:outline-none focus:shadow-outline"
                type="text"
            ...
            <button
              ...
              className="bg-[#000000] text-white py-2 px-4 hover:bg-[#000000] focus:outline-none focus:shadow-outline w-[100%] rounded-[3.91433px]"
            >
              Sign Up
            </button>
          </form>
        ...
        {screenWidth < 640 ? (
          <div className="sm:mt-[292.5px] mt-[2rem] text-[white] mb-[2rem]">
            <p className="font-[500]">Contact us:</p>
            <p>contact@getcleva.com</p>
          </div>
        ) : null}
      ...
      <div className="px-[1rem] sm:pl-[0rem] pb-[1rem] text-center sm:text-left sm:mx-[5rem] text-[#000000] text-[12px] font-[200] leading-[20px] mt-[62.68px]">
        ...
        <h1>
          Cleva, a company incorporated under the laws of Delaware, the United
          States of America, is a financial technology company and not a bank.
