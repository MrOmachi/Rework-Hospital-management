      ...
      <Row>
        ...
        <Col md={12} sm={12} lg={12}>
          <div className="padding details">
            <div style={{ margin: 10 }}>
              <h3>
                <b>{formatAmount(account.Balance.Money, account.Currency)}</b>
              </h3>
                ...
                {props.transactions.length > 0 ? (
                  props.transactions.filter(function (transaction) {
                    if (transaction.TransactionDetail.MakePayment) {
                      return (
                        transaction.TransactionDetail.MakePayment.Currency ===
                        account.Currency
                      );
                    }
                  }).length > 0 ? (
                    props.transactions
                      ...
                      .map(function (transaction, i) {
                        return (
                          <Card key={i} className="transaction">
                            <Card.Body>
                              <Image
                                src={
                                  transaction.TransactionDetail.MakePayment
                                    .Image
                                }
                                width={60}
