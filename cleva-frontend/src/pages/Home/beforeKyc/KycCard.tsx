...
const Card = ({ title, body, text, icon }: IKycCard) => {
  return (
    <div className="w-[33%]">
      ...
      <div className={text === "Required" ? " bg-[#FFFCF2] border max-w-sm rounded-md overflow-hidden shadow-lg px-6 py-4 flex align items-start gap-2 h-[170px] pb-12 " : " max-w-sm border rounded-md overflow-hidden shadow-lg px-6 py-4 flex align items-start gap-2 h-[170px] pb-12 "}>
        <div className=" w-[100px] pt-[4px] left-[8px] ">
          <img className="w-full" src={icon as string} alt="logo" />  
        </div>
        <div className=" text-left ">
          <div className="">
            <div className="font-bold pt-1 h-[21px] text-[14px] leading-5 mb-2">{title}</div>
