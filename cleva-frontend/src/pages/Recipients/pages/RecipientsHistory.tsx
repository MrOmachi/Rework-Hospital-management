...
import { MdOutlineModeEditOutline, MdSubdirectoryArrowRight } from "react-icons/md";
  ...
  <div className='py-5'>
   ...
   <div className='flex justify-between pt-5'>
    <div className='w-[45%] text-[13px] font-semibold'>
     {
      recipients.map((info) => (
       <div
        key={info.id}
        className='flex items-center justify-between showArrow mb-2'>
        <div className='
                  border rounded-md 
                  py-4 ps-5 w-[70%]
                  hover:bg-lime-50'>
        ...
        <span className='w-[30%] text-[70px] text-sm hideArrow '>
    ...
    <div className='border rounded-md w-[50%]'>
     ...
     <div 
     className='flex items-center w-70% justify-between w-[70%] m-auto pt-6 pb-12 text-[13px] font-semibold'>
