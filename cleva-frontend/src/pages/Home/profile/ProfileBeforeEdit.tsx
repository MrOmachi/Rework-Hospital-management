  ...
  <div className=" w-[88%] pb-[2em] ">
   <header>
    <div className=" bg-[#F2F2F2] px-3 flex items-center  mt-6 mb-4 py-3 text-[13px] text-[#111111] rounded-md ">
     <span className='me-3 text-[20px]'><MdOutlineErrorOutline /></span>
     Your account needs to be verified.
     <span className="underline text-[#A06202] font-semibold ">
    ...
    <section>
     ...
     <div className='pt-[1em] flex items-start gap-6'>
      ...
      {
       !image && 
       <span className=" rounded-full h-[100px] bg-[#F2F2F2] text-[40px] border-[3px] border-[#cccccc] text-center pt-4 w-[10%]">
        <b>TA</b>
       </span>
      }

      <button 
       onClick={() => image == true ? setImage(false) : setImage(true)}
      className="border-2 
      border-[#9a9a9a] 
      py-2 px-6 text-[#787979]  
      rounded-[8px] ">
       change
      </button>
